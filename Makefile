...
.PHONY: test
test:
	cd ${ROOT_DIR} && PYTHONPATH="./py_gist_pile2:./py_gist_pile2/date:./py_gist_pile2/greeting:./py_gist_pile2/boolean" LOG_PREPEND_TIMESTAMP=1 LOG_DEBUG=1 python3 -m unittest discover -v
